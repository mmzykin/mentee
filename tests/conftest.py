...
class MockChat:
    ...
    def __init__(self, id: int = 111111111, type: str = "private", title: str = None):
        self.id = id
        self.type = type
        self.title = title
...
def student_factory(clean_db):
    ...
    def _create_student(user_id: int = None, username: str = None, first_name: str = None) -> Dict:
        import random
...
def capture_notifications():
    ...
    async def capture(chat_id, text, **kwargs):
        notifications.append({"chat_id": chat_id, "text": text, **kwargs})
