...
class TestMeetings:
    ...
    def test_create_meeting(self, clean_db):
        ...
        meeting_id = db.create_meeting(
            student['id'], "Code Review", "https://meet.google.com/xxx",
            "2025-12-01T15:00:00", 30, 123, "Notes"
        )
        assert meeting_id > 0
    ...
    def test_get_meetings(self, clean_db):
        ...
        # Future meeting
        db.create_meeting(
            student['id'], "Meeting", "link",
            (datetime.now() + timedelta(days=1)).isoformat(), 30, 123
        )
